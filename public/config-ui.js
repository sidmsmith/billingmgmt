...
const ENTITY_FIELDS = {
  ...
  rulesTransaction: [
    ...
    { key: "chargeSumType", label: "Charge Sum Type", type: "select", options: ["line", "transaction", "transactionByChargeColumn", "transactionByChargeTag", "activity", "activityByChargeTag"] },
  ...
  rulesStorage: [
    ...
    { key: "chargeSumType", label: "Charge Sum Type", type: "select", options: ["line", "transaction", "transactionByChargeColumn", "transactionByChargeTag"] },
