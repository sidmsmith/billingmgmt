...
const ENTITY_FIELDS = {
  ...
  rulesTransaction: [
    ...
    { key: "chargeType", label: "Charge Type", type: "select", options: ["per", "fixed", "tier", "absoluteTier", "formula"] },
  ...
  rulesStorage: [
    ...
    { key: "chargeType", label: "Charge Type", type: "select", options: ["per", "fixed", "tier", "formula"] },
